...
public class RSA {
    private RSA(){}
    public static HashMap getRSAKeysAsString() throws Exception {
    ...
    public static String getRSAEncrypt(String publicKeyStr, String clearText) throws Exception {
    ...
    public static String getRSADecrypt(String privateKeyStr, String encryptStr) throws Exception {
        Cipher cipher = Cipher.getInstance("RSA");
        KeyFactory keyFactory = KeyFactory.getInstance("RSA");
